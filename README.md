...
- `monthly_cps_w_ai_scores.dta` - The first CPS extract, cleaned and with AI exposure scores for each occupation. Note: This data is created using `ai_exposure_crosswalk_to_scores_v2.do`.
- - `monthly_cps_w_exp_v2.dta` - The second CPS extract, cleaned and with AI exposure scores for each occupation. Note: This data is created using `ai_exposure_crosswalk_to_scores_v2.do`.
